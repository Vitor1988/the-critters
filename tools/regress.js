...
const { POSE, corre: corre0, vale, assercoesV3, assercoesAudio,
  ...
  assercoesEmocoes, assercoesFalaBaixa } = require('./lib/guardas');
...
bateria('assercoes da fala baixa:', assercoesFalaBaixa(eng), 'lowSpeech ainda nao existe no engine (ou nao ha traces) — assercoes saltadas');
